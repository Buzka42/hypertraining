            ...
            <section id="hero" className="relative h-[100dvh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-5xl">
                    ...
                    <h1 className="hero-text font-heading text-6xl md:text-8xl font-bold uppercase tracking-tighter mb-6 leading-none">
                        {t(<>Nauka. <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-hyper-indigo to-blue-400">Nie Przypadek.</span><span className="sr-only"> Trener Personalny Warszawa Praga Południe Gocław Patryk Dębowski</span></>, <>Science. <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-hyper-indigo to-blue-400">No Guesswork.</span><span className="sr-only"> Personal Trainer Warsaw Praga Patryk Debowski</span></>)}
                    </h1>
